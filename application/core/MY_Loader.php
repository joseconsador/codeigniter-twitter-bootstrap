...
class MY_Loader extends CI_Loader {
	...
	function __construct()
	{
		...
		$this->_ci_module_view_path = MODPATH . $RTR->fetch_module() . '/' . $RTR->fetch_directory() . 'views/';
	...
	{	
		...
		if ($_ci_path == '')
		{
			...
			$_ci_module_path = $this->_ci_module_view_path . $_ci_file;
		}
		else
		{
        ...
        // Check the current module's view files first.
        if ( ! file_exists($_ci_module_path)) 
        {
            // Now proceed to normal checking;
